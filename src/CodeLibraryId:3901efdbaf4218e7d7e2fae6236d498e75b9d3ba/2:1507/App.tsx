...
function Frame6() {
  return (
    <div className="bg-[#ebff57] box-border content-stretch flex flex-row gap-2.5 items-center justify-center px-[30px] py-[15px] relative rounded-[62px] shrink-0">
...
function Frame10() {
  return (
    <div
      className="absolute bg-[#0a0a0c] box-border content-stretch flex flex-row items-center justify-between px-[100px] py-5 top-0 translate-x-[-50%] w-[1920px]"
      style={{ left: "calc(50% + 0.5px)" }}
    >
      <div className="absolute border border-[rgba(255,255,255,0.1)] border-solid inset-0 pointer-events-none" />
      <div className="font-['Clash_Grotesk:Semibold',_sans-serif] leading-[0] not-italic relative shrink-0 text-[#ffffff] text-[37px] text-center text-nowrap">
...
function Frame2147227226() {
  return (
    <div className="box-border content-stretch flex flex-row font-['Clash_Grotesk:Regular',_sans-serif] gap-5 items-center justify-center leading-[0] not-italic p-0 relative shrink-0 text-[#ffffff] text-[62px] text-center text-nowrap w-[1137px]">
      <div className="relative shrink-0">
...
function Frame2147227217() {
  return (
    <div className="box-border content-stretch flex flex-col gap-5 items-start justify-start p-0 relative shrink-0 w-[605px]">
      <Frame18 />
      <div
        className="font-['Clash_Grotesk:Regular',_sans-serif] leading-[0] min-w-full not-italic relative shrink-0 text-[#ffffff] text-[62px] text-left"
        style={{ width: "min-content" }}
      >
        <p className="block leading-[1.116]">
...
function Frame2147227238() {
  return (
    <div className="box-border content-stretch flex flex-row gap-6 items-center justify-start p-0 relative shrink-0 w-[1055px]">
      <Frame2147227224 />
      <Frame2147227223 />
    </div>
  );
...
function Frame2147227218() {
  return (
    <div className="box-border content-stretch flex flex-row gap-[60px] items-start justify-center p-0 relative shrink-0 w-[1720px]">
      <Frame2147227240 />
      <Frame2147227225 />
    </div>
  );
...
function Frame2147227245() {
  return (
    <div className="box-border content-stretch flex flex-row gap-[60px] items-center justify-start p-0 relative shrink-0 w-[1920px]">
      ...
      <div className="relative shrink-0 size-10" data-name="*">
        <svg
          className="block size-full"
          fill="none"
          preserveAspectRatio="none"
...
function Frame2147227211() {
  return (
    <div className="absolute box-border content-stretch flex flex-col gap-4 items-start justify-start left-[70px] p-0 top-7 w-[550px]">
      <Frame2147227209 />
      <Frame2147227210 />
      <div
...
function Frame1410116674() {
  return (
    <div className="bg-neutral-900 h-[615px] overflow-clip relative rounded-[60px] shrink-0 w-[1860px]">
      <Frame1410116658 />
      <Group1410114448 />
      <Frame2147227211 />
    </div>
...
function Frame2147229271() {
  return (
    <div className="absolute box-border content-stretch flex flex-col gap-40 items-center justify-start left-[-5px] p-0 top-0 w-[1925px] bg-[rgba(0,0,0,1)]">
      <Frame1 />
      <Frame17 />
      <Frame2147227218 />
      <Frame2147227219 />
